...
module.exports.displayHomePage = (req, res, next) => {
    res.render('index', {title: 'Welcome To My Site!', displayName: req.user ? req.user.displayName : ''});
}
...
module.exports.displayServicesPage = (req, res, next) => {
    res.render('services', {title: 'My Skills', displayName: req.user ? req.user.displayName : ''});
}
